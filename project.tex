...
So while this rule seems prevalent in the style guides we've looked at,
...
rule while coders are working. We suggest here that many of the violations
...
\centering
\begin{tabular}{|c||c|c||c|}\hline
Project & \texttt{if} violations & Lines & Lines per instance \\ \hline\hline
SMLNJ & 25 & 81124 & 3245.0 \\
MLKit & 182 & 530334 & 2913.9 \\
FoxNet & 0 & 8545 & -- \\
Til & 149 & 222317 & 1492.1 \\
MLton & 72 & 168323 & 2337.8 \\ \hline
\end{tabular}
...
On inspection, the violations tend to fall into two groups: the first comprised of
missed opportunities to rewrite the \texttt{if} statement in potentially simpler way; the second
made up of complicated \texttt{if} expressions where rewriting may not improve readability at all.
